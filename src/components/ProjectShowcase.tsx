...
const projects = [
  {
    name: "NEURAL_ARCH_V2",
    description:
      "Next-gen visualization engine for deep learning models, rendering complex tensors in real-time using WebGL.",
    tags: ["React", "TensorFlow", "PostgreSQL"],
  },
  {
    name: "QUANTUM_LEDGER",
    description:
      "A high-throughput distributed database designed for post-quantum cryptographic standards.",
    tags: ["Rust", "gRPC", "Docker"],
  },
  {
    name: "SYNTAX_HUNT",
    description:
      "Static analysis tool for catching memory leaks in low-level C++ applications before compilation.",
    tags: ["LLVM", "Python", "Qt"],
  },
  {
    name: "VOID_COMMERCE",
    description:
      "Headless commerce engine capable of handling 100k+ concurrent transactions with sub-10ms latency.",
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {p.tags.map((t) => (
                  <span
                    key={t}
                    className="border border-border px-3 py-1 font-mono text-[10px] uppercase tracking-widest text-muted-foreground transition-colors group-hover:border-primary/30"
                  >
                    {t}
                  </span>
                ))}
