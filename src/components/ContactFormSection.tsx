    ...
    <section id="contact" className="border-b border-border py-24">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <h2 className="mb-4 text-3xl font-bold uppercase tracking-tight text-foreground md:text-4xl">
          READY TO START THE
          <br />
          <span className="text-primary">NEXT_BUILD?</span>
        </h2>
          ...
          <div className="flex flex-col justify-center">
            <div className="border border-border p-6">
              ...
              <div className="space-y-3 font-mono text-xs text-muted-foreground">
                <p>
                  &gt; Connection: <span className="text-primary">OPEN</span>
                </p>
                <p>
                  &gt; Response Time:{" "}
                ...
                <p>
                  &gt; Availability:{" "}
                  <span className="text-primary">ACCEPTING_PROJECTS</span>
                </p>
                <p>
                  &gt; Preferred:{" "}
                  <span className="text-foreground">Remote / Hybrid</span>
                </p>
              </div>
