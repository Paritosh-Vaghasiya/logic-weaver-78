const HeroSection = () => {
  return (
    <section id="hero" className="relative flex min-h-screen items-center border-b border-border scanline">
      <div className="mx-auto w-full max-w-7xl px-6 py-32">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="mb-2 font-mono text-xs text-primary animate-fade-in-up">System.ready()</p>
            <h1 className="mb-8 text-5xl font-bold uppercase leading-none tracking-tight text-foreground md:text-7xl lg:text-8xl" style={{ animationDelay: "0.1s" }}>
              ARCHITECTING<br />
              <span className="text-glow text-primary">LOGIC</span><br />
              INTO REALITY.
            </h1>

            <div className="mb-8 space-y-2 border-l-2 border-primary pl-4 font-mono text-xs text-muted-foreground" style={{ animationDelay: "0.2s" }}>
